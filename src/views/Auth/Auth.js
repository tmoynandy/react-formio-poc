      ...
      <div className="row">
        {/* { AppConfig.projectUrl !== 'https://reactstarter.form.io' ?
          <div className="col-md-12">
            <div className="alert alert-warning">To register an Admin user, go to your project in the form.io portal, navigate to the Admin resource and create an Admin.</div>
          </div>
          : null
        } */}
